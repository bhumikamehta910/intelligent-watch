  ...
  head: () => ({
    meta: [
      ...
      { title: "PulseIQ — Know what changed. Understand what matters." },
      {
        name: "description",
        content:
          "An intelligent market watchlist: what changed since your last visit, why it changed, and what deserves attention now.",
      },
      { property: "og:title", content: "PulseIQ — Know what changed. Understand what matters." },
      {
        property: "og:description",
        content: "An intelligent market watchlist built for signal, not tickers.",
      },
